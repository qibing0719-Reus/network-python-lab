...
from day12.day12_homework import qytang_multicmd
...
class NetworkDevice:
    ...
    def apply(self):
        ...
        for iface in self.interfaces:
            ...
            if iface.description: # 如果有 description，追加: description {描述}
                cmds.append(f'description {iface.description}')

            if iface.status:  # 根据 status 追加 'no shutdown' 或 'shutdown'
...
if __name__ == '__main__':
    ...
    r1 = NetworkDevice('192.168.56.101', 'admin', 'Cisc0123')
