...
def main():
    ...
    parser.add_argument('-i','--ip', required=True, help='设备的IP地址')
    parser.add_argument('-u', '--username', required=True, help='登陆用户名')
    parser.add_argument('-p', '--password', required=True, help='登陆密码')
